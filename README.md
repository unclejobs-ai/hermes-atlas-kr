...
- upstream README/research/repos/drafts 문서 lexical RAG 확장
- 커스텀 OG 이미지
- 커스텀 도메인 연결 문서

## 아직 완전 한글판이 아닌 부분

- 각 GitHub 프로젝트 README 전문 한국어 번역
- 모든 프로젝트 설명의 사람 손 검수 번역
- OpenRouter embedding 기반 hybrid retrieval(현재 요청에 따라 미진행)
- 실제 커스텀 도메인 연결(도메인 확정 필요)
...
- `data/docs.raw.json`: upstream README/research/repos/drafts 원문 문서 RAG 근거
